...
def expand(modules, task):
    ...
    add('flow', 'conditions', 'boundary', 'Practice the exact boundary',
        ...
        ['For score = 70, create above using > 70 and qualifies using >= 70.', 'Set different to whether score differs from 70, using !=.'],
        'score = 70\n',
        'score = 70\nabove = score > 70\nqualifies = score >= 70\ndifferent = score != 70',
    ...
    add('collections', 'dicts', 'items', 'Visit keys and values together',
        ...
        ['Create values mapping each item to stock quantity multiplied by unit price.', 'Set inventory_value to the sum of those values.'],
