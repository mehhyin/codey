...
'''
    ...
    m=section('flask','Build local web applications','Routes, forms, escaped templates, and persistent records.','Make a local task tracker',[
        ...
        ('Template escaping','render_template_string("<p>{{ name }}</p>", name=name)','Jinja escapes values passed into HTML templates. Keep HTML structure separate from untrusted text. The preview database lasts until you start another preview or stop Codey.')])
